...
public class ResBundleTest extends TestCase
{
	...
	{
		ResBundle rb = new ResBundle("java/src/com/ilib/test/resources");
		assertNotNull(rb);
	}
	
	public void testNullLocale()
	{
		ResBundle rb = new ResBundle("java/src/com/ilib/test/resources", null);
		assertNotNull(rb);
	...
	public void testEmptyLocale()
	{
		...
		ResBundle rb = new ResBundle("java/src/com/ilib/test/resources", l);
		assertNotNull(rb);
	...
	public void testConstructorResourcesLocaleType()
	{
		...
		ResBundle rb = new ResBundle("java/src/com/ilib/test/resources", l, "html");
		assertNotNull(rb);
	}
	
	public void testContainsSourceTrue()
	{
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", new IlibLocale("fr-FR"));
	...
	{
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", new IlibLocale("es-ES"));
		assertNotNull(resBundle);
	...
	{
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", new IlibLocale("es-MX"));
		assertNotNull(resBundle);
	...
	{
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", new IlibLocale("zh-Hans-CN"));
		assertNotNull(resBundle);
	...
	{
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", new IlibLocale("zh-HK"));
		assertNotNull(resBundle);
	...
	{
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", new IlibLocale("it-IT"));
		assertNotNull(resBundle);
	...
	public void testGetLocaleWithResourcesGerman()
	{
		...
		ResBundle resBundle = new ResBundle("java/src/com/ilib/test/resources", locale);
		assertNotNull(resBundle);
