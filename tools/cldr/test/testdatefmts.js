...
function testDistanceAgainstEmptyLeft() {
	var left = {
	    "locale": "en-AU",
	    "gregorian": {
	        "date": {
	...
	assertEquals(3, aux.distance(left, {}));
}

function testDistanceAgainstEmptyRight() {
	var right = {
	    "locale": "en-AU",
	    "gregorian": {
	        "date": {
	...
	assertEquals(3, aux.distance({}, right));
}

function testDistanceDifferentComplexTypesWithDifferentTypes1() {
	var left = {
	    "order": {
	        "s": "{date} {time}",
	        "m": "{date} {time}",
...
function testDistanceDifferentComplexTypesWithDifferentTypes2() {
	var left = {
	    "order": {
	        "s": "{date} {time}",
	        "m": "{date} {time}",
    ...
    assertEquals(4, aux.distance(left, right));
}

function testDistanceDifferentComplexTypesWithDifferentTypes3() {
	var left = {
	    "order": {
	        "s": "{date} {time}",
	        "m": "{date} {time}",
...
function testDistanceUndefinedRightComplex() {
	var right = {
		b: true,
		c: false,
		e: "asdf",
    ...
    assertEquals(7, aux.distance(undefined, right));
}
...
function testDistanceUndefinedLeftComplex() {
	var left = {
		b: true,
		c: false,
		e: "asdf",
    ...
    assertEquals(7, aux.distance(left, undefined));
}
...
function testMergePromotePrune1() {
	var formats = {
		data: {
			"order": "{date} {time}",
            "dmy": {
...
function testMergePromotePrune2() {
	var formats = {
	    "en": {
	        "IE": {
	            "data": {
	...
	aux.pruneFormats(formats);
	 ...
	 // pruned out
	assertUndefined(formats.en.data.a0);
	assertUndefined(formats.en.data["MMM2-persian"]);
	assertTrue(common.isEmpty(formats.en.data));
	
    assertUndefined(formats.en.US.data.a0);
    assertUndefined(formats.en.US.data["MMM2-persian"]);
    
	assertNotUndefined(formats.en.IE.data.a0);
	assertUndefined(formats.en.IE.data["MMM2-persian"]);
	
	assertTrue(common.isEmpty(formats.en.BZ.data));
}
