...
resources_dateformat_data = getDateFormats(undefined, undefined, undefined, localeData.data);
for (language in localeData) {
	if (language && localeData[language] && language !== 'data' && language !== 'merged') {
...
function getDateFormats(language, script, region, data) {
	...
	util.print("date format values are :" + JSON.stringify(arr_values) + "*********************************" + "\n");
	var date = {};
	var dm = {};
	//var dmwy = {};
	var dmy = {};
	...
	//var n = {};
	for (var i = 0; i < keys_dateformats.length; i++) {
		if ((keys_dateformats[i] === "Md") || (keys_dateformats[i] === "Mdd")) {
		...
		// end of short
		if ((keys_dateformats[i] === "MMdd") || (keys_dateformats[i] === "MMd")) {
		...
		if ((keys_dateformats[i] === "MMMd") || (keys_dateformats[i] === "MMMdd")) {
		...
		if ((keys_dateformats[i] === "MMMMd") || (keys_dateformats[i] === "MMMMdd")) {
		...
		if ((keys_dateformats[i] === "yM") || (keys_dateformats[i] === "yyM") || (keys_dateformats[i] === "yyyyM")) {
		...
		if ((keys_dateformats[i] === "yyyyMM") || (keys_dateformats[i] === "yyMM") || (keys_dateformats[i] === "yMM")) {
		...
		if ((keys_dateformats[i] === "yMMM") || (keys_dateformats[i] === "yyMMM") || (keys_dateformats[i] === "yyyyMMM")) {
		...
		if ((keys_dateformats[i] === "yyyyMMMM") || (keys_dateformats[i] === "yyMMMM") || (keys_dateformats[i] === "yMMMM")) {
		...
		if (keys_dateformats[i] === "yyyyMd") {
			...
			for (var j = 0; j < arr_values.length; j++) {
				if (((arr_values[j].split("M").length - 1) == 1) && ((arr_values[j].split("y").length - 1) >= 1) && ((arr_values[j].split("d").length - 1) >= 1)) {
					dmy["s"] = (arr_values[j].indexOf("y") > arr_values[j].indexOf("d")) ? (arr_values[j].substring(arr_values[j].indexOf("d"), 1 + arr_values[j].indexOf("y"))) : (arr_values[j].substring(arr_values[j].indexOf("y"), 1 + arr_values[j].indexOf("y")));
					flag = true;
					break;
				}
			}
			if (flag == false) {
				...
				dmy["s"] = (short.indexOf("d") < short.indexOf("y")) ? short.substring(short.indexOf("d"), 1 + short.indexOf("y")) : (short.indexOf("y"), 1 + short.indexOf("d"));
			}
		}

		if (keys_dateformats[i] === "yyMMdd") {
			my["m"] = available_formats["yyMMdd"];
			...
			for (var j = 0; j < arr_values.length; j++) {
				if (((arr_values[j].split("M").length - 1) == 2) && ((arr_values[j].split("y").length - 1) >= 1) && ((arr_values[j].split("d").length - 1) >= 1)) {
					dmy["m"] = (arr_values[j].indexOf("y") > arr_values[j].indexOf("d")) ? (arr_values[j].substring(arr_values[j].indexOf("d"), 1 + arr_values[j].indexOf("y"))) : (arr_values[j].substring(arr_values[j].indexOf("y"), 1 + arr_values[j].indexOf("d")));
					flag = true;
					break;
				}
			}
			if (flag == false) {
				...
				dmy["m"] = medium.indexOf("d") < medium.indexOf("y") ? medium.substring(medium.indexOf("d"), 1 + medium.indexOf("y")) : medium.indexOf("y"), 1 + medium.indexOf("d");
			}
		}

		if (keys_dateformats[i] === "yyMMMd" && keys_dateformats[i] === "yyyyMMMd") {
			...
			for (var j = 0; j < arr_values.length; j++) {
				if (((arr_values[j].split("M").length - 1) == 3) && ((arr_values[j].split("y").length - 1) >= 1) && ((arr_values[j].split("d").length - 1) >= 1)) {
					dmy["l"] = (arr_values[j].indexOf("y") > arr_values[j].indexOf("d")) ? (arr_values[j].substring(arr_values[j].indexOf("d"), 1 + arr_values[j].indexOf("y"))) : (arr_values[j].substring(arr_values[j].indexOf("y"), 1 + arr_values[j].indexOf("d")));
					flag = true;
					break;
				}
			}
			if (flag == false) {
				...
				dmy["l"] = long.indexOf("d") < long.indexOf("y") ? long.substring(long.indexOf("d"), 1 + long.indexOf("y")) : long.indexOf("y"), 1 + long.indexOf("d");
			}
		}

		if (keys_dateformats[i] === "yMMMMd") {
			dmy["f"] = available_formats["yMMMMd"];
		} else if (available_formats["yMMMMd"] === undefined) {
			var flag = false;
			for (var j = 0; j < arr_values.length; j++) {
				if (((arr_values[j].split("M").length - 1) == 3) && ((arr_values[j].split("y").length - 1) >= 1)) {
					dmy["f"] = (arr_values[j].indexOf("y") > arr_values[j].indexOf("d")) ? (arr_values[j].substring(arr_values[j].indexOf("d"), 1 + arr_values[j].indexOf("y"))) : (arr_values[j].substring(arr_values[j].indexOf("y"), 1 + arr_values[j].indexOf("d")));
					flag = true;
					break;
				}
			}
			if (flag == false) {
				...
				dmy["f"] = (full.indexOf("d") < full.indexOf("y")) ? full.substring(full.indexOf("d"), 1 + full.indexOf("y")) : (full.indexOf("y"), 1 + full.indexOf("d"));
			}
		...
		if (keys_dateformats[i] === "d") {
			d["s"] = available_formats["d"];
		} else if (available_formats["d"] === undefined) {
			// var flag=false;
			for (var j = 0; j < arr_values.length; j++) {
		...
		if (keys_dateformats[i] === "MMM") {
			m["l"] = available_formats["M"];
...
writeDateFormats(undefined, undefined, undefined, resources.data);*/
