...
function testRequireSingleFile() {
	...
	var mod = require("./root/legacy/testfiles/datefmt2.js");
...
function testRequireSingleFileWithSideEffects() {
    ...
    var mod = require("./root/legacy/testfiles/foobar.js");
...
function testRequireSingleFileDependenciesLoaded() {
    ...
    var mod = require("./root/legacy/testfiles/asdf.js");
    assertNotUndefined(mod);
...
function testRequireDoNotReloadSameFile() {
	...
	var mod = require("./root/legacy/testfiles/qwerty.js");
	assertNotUndefined(mod);
    ...
    ilib.Qwerty = require("./root/legacy/testfiles/qwerty.js");
    assertNotUndefined(ilib.Qwerty);
