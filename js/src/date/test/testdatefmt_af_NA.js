/*
 * testdatefmt_af_NA.js - test the date formatter object in พฤaiLand
 * 
...
function testDateFmtConstructorEmpty_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA"});
    
    assertNotNull(fmt);
}

function testDateFmtSimpleShort_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "short"});
    assertNotNull(fmt);
...
function testDateFmtSimpleMedium_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "medium"});
    assertNotNull(fmt);
...
function testDateFmtSimpleLong_af_NA_Jan() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full"});
    assertNotNull(fmt);
...
function testDateFmtSimpleLong_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "long"});
    assertNotNull(fmt);
...
function testDateFmtSimpleTimeShort_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "short", type: "time"});
    assertNotNull(fmt);
...
function testDateFmtSimpleTimeMedium_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "medium", type: "time"});
    assertNotNull(fmt);
...
function testDateFmtSimpleTimeLong_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", timelength: "long", type: "time"});
    assertNotNull(fmt);
...
function testDateFmtSimpleTimeFull_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", type: "time"});
    assertNotNull(fmt);
...
function testDateFmtDateTimeSimpleShort_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "short", type: "datetime"});
    assertNotNull(fmt);
...
function testDateFmtDateTimeSimpleMedium_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "medium", type: "datetime"});
    assertNotNull(fmt);
...
function testDateFmtDateTimeSimpleLong_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "long", type: "datetime"});
    assertNotNull(fmt);
...
function testDateFmtDateTimeSimpleFull_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", type: "datetime"});
    assertNotNull(fmt);
...
function testDateFmtTemplateClock12SwitchHH_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", clock: "12", template: "HH:mm"});
    assertNotNull(fmt);
...
function testDateFmtTemplateClock12Switchkk_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", clock: "12", template: "kk:mm"});
    assertNotNull(fmt);
...
function testDateFmtTemplateClock24Switchhh_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", clock: "24", template: "hh:mm"});
    assertNotNull(fmt);
...
function testDateFmtTemplateClock24SwitchKK_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", clock: "24", template: "KK:mm"});
    assertNotNull(fmt);
...
function testDateFmtTemplateNoClockNotFollowLocaleDefault12hh_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", template: "hh:mm"});
    assertNotNull(fmt);
...
function testDateFmtTemplateNoClockNotFollowLocaleDefault12KK_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", template: "KK:mm"});
    assertNotNull(fmt);
...
function testDateFmtTypeDate_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "date"});
    assertNotNull(fmt);
...
function testDateFmtTypeTime_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time"});
    assertNotNull(fmt);
...
function testDateFmtTypeDateTime_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "datetime"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "y"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "m"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsN_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "n"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsD_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "d"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsDM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "dm"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsMY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "my"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsDMY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "dmy"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsWDM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "wdm"});
    assertNotNull(fmt);
...
function testDateFmtShortDateComponentsWDMY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", date: "wdmy"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "y"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "m"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsD_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "d"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsDM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "dm"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsMY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "my"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsDMY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "dmy"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsWDM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "wdm"});
    assertNotNull(fmt);
...
function testDateFmtFullDateComponentsWDMY_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", length: "full", date: "wdmy"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsS_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "s"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "m"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsH_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "h"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsMS_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "ms"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsHM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "hm"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsHMS_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "hms"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsHMA_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "hma"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsHMZ_af_NA() {
    ...
    assertEquals("1:45 WAST", fmt.format(date));
}
...
function testDateFmtShortTimeComponentsHMAZ_af_NA() {
    ...
    assertEquals("1:45 nm. WAST", fmt.format(date));
}

function testDateFmtShortTimeComponentsHMSA_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", time: "hmsa"});
    assertNotNull(fmt);
...
function testDateFmtShortTimeComponentsHMSZ_af_NA() {
    ...
    assertEquals("1:45:37 WAST", fmt.format(date));
}
...
function testDateFmtShortTimeComponentsHMSAZ_af_NA() {
    ...
    assertEquals("1:45:37 nm. WAST", fmt.format(date));
}


function testDateFmtFullTimeComponentsS_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "s"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "m"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsH_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "h"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsMS_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "ms"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsHM_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "hm"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsHMS_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "hms"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsHMA_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "hma"});
    assertNotNull(fmt);
...
function testDateFmtFullTimeComponentsHMSA_af_NA() {
    var fmt = new ilib.DateFmt({locale: "af-NA", calendar: "gregorian", type: "time", length: "full", time: "hmsa"});
    assertNotNull(fmt);
