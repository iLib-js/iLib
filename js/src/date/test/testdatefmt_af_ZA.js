/*
 * testdatefmt_af_ZA.js - test the date formatter object in พฤaiLand
 * 
...
function testDateFmtTemplateCalendar_af_ZA() {
    var fmt = new ilib.DateFmt({locale: "af-ZA", calendar: "gregorian", calendar: "julian", template: "yyyy-MM-dd"});
    assertNotNull(fmt);
