 ...
 * @return {number} the rd date as a number
 */
ilib.Date.PersDate.prototype.getRataDie = function() {
 ...
 */
ilib.Date.PersDate.prototype.calcComponents = function (rd) {
	var days400,
		days100,
		days4,
		days1,
	...
	*/
	...
	// explicitly call the persian rd calculator instead of any 
	// possible overloaded ones from subclasses
	remainder = rd - ilib.Date.PersDate.prototype.calcRataDie.call(this, ret) + 1;
	
	cumulative = ilib.Cal.Persian.prototype.isLeapYear.call(this.cal, ret.year) ? 
		ilib.Date.PersDate.cumMonthLengthsLeap : 
		ilib.Date.PersDate.cumMonthLengths; 
 ...
 */
ilib.Date.PersDate.prototype.setRd = function (rd) {
 ...
 */
ilib.Date.PersDate.prototype.setJulianDay = function (date) {
	var jd = (typeof(date) === 'number') ? new ilib.JulianDay(date) : date,
		rd;	// rata die -- # of days since the beginning of the calendar
	
	rd = jd.getDate() - ilib.Date.PersDate.epoch; 	// Julian Days start at noon
	this.setRd(rd);
};
 ...
 * @return {number} the day of the week
 */
ilib.Date.PersDate.prototype.onOrBeforeRd = function(rd, dayOfWeek) {
 ...
 * @return {number} the day of the week
 */
ilib.Date.PersDate.prototype.onOrAfterRd = function(rd, dayOfWeek) {
 ...
 * @return {number} the day of the week
 */
ilib.Date.PersDate.prototype.beforeRd = function(rd, dayOfWeek) {
 ...
 * @return {number} the day of the week
 */
ilib.Date.PersDate.prototype.afterRd = function(rd, dayOfWeek) {
 ...
 */
ilib.Date.PersDate.prototype.firstSunday = function (year) {
...
/**
 * Return a new Persian date instance that represents the first instance of the 
 ...
 */
ilib.Date.PersDate.prototype.before = function (dow) {
 ...
 * @return {ilib.Date} the date being sought
 */
ilib.Date.PersDate.prototype.after = function (dow) {
 ...
 * @return {ilib.Date} the date being sought
 */
ilib.Date.PersDate.prototype.onOrBefore = function (dow) {
 ...
 * @return {ilib.Date} the date being sought
 */
ilib.Date.PersDate.prototype.onOrAfter = function (dow) {
 ...
 */
ilib.Date.PersDate.prototype.getWeekOfYear = function() {
	var rd = Math.floor(this.getRataDie()),
 ...
 * Persian calendar consider different days of the week to be the beginning of
 ...
 */
ilib.Date.PersDate.prototype.getWeekOfMonth = function(locale) {
...
/**
 * Return the unix time equivalent to this Persian date instance. Unix time is
 ...
 */
ilib.Date.PersDate.prototype.getTime = function() {
 ...
 */
ilib.Date.PersDate.prototype.setTime = function(millis) {
	var rd = 719163 + millis / 86400000;
	this.setRd(rd);
};

/**
 * Return a Javascript Date object that is equivalent to this Persian date
 * object.
 * 
 * @return {Date|undefined} a javascript Date object
 */
ilib.Date.PersDate.prototype.getJSDate = function() {
 ...
 */
ilib.Date.PersDate.prototype.getJulianDay = function() {
	return this.getRataDie() + ilib.Date.PersDate.epoch;
};
...
/**
 * Return the time zone associated with this Persian date, or 
 ...
 */
ilib.Date.PersDate.prototype.getTimeZone = function() {
	return this.timezone || "local";
};

/**
 * Set the time zone associated with this Persian date.
 * @param {string} tzName the name of the time zone to set into this date instance,
 * or "undefined" to unset the time zone 
 */
ilib.Date.PersDate.prototype.setTimeZone = function (tzName) {
	if (!tzName || tzName === "") {
