...
function testFormatITStyle0(){
	...
	var fmt = new ilib.PhoneFmt({locale: "it-IT", style: "default"});
...
function testFormatITStyle1(){
	...
	var fmt = new ilib.PhoneFmt({locale: "it-IT", style: "trattini"});
	formatted = fmt.format(parsed);
...
function testFormatITStyle2(){
	...
	var fmt = new ilib.PhoneFmt({locale: "it-IT", style: "slash"});
	formatted = fmt.format(parsed);
