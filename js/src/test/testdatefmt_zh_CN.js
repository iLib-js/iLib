...
function testDateFmtSimpleLong() {
    ...
    assertEquals("2011年09月29日", fmt.format(date));
}
...
function testDateFmtDateTimeSimpleShort() {
    ...
    assertEquals("11-09-29下午01:45", fmt.format(date));
}
...
function testDateFmtDateTimeSimpleMedium() {
    ...
    assertEquals("2011-09-29下午01:45", fmt.format(date));
}
...
function testDateFmtDateTimeSimpleLong() {
    ...
    assertEquals("2011年09月29日下午01:45", fmt.format(date));
}
...
function testDateFmtDateTimeSimpleFull() {
    ...
    assertEquals("2011年九月29日下午01:45", fmt.format(date));
}
...
function testDateFmtShortDateComponentsWDM() {
    ...
    assertEquals("09-29四", fmt.format(date));
}
...
function testDateFmtShortDateComponentsWDMY() {
    ...
    assertEquals("11-09-29四", fmt.format(date));
}
...
function testDateFmtFullDateComponentsWDM() {
    ...
    assertEquals("九月29日星期四", fmt.format(date));
}
...
function testDateFmtFullDateComponentsWDMY() {
    ...
    assertEquals("2011年九月29日星期四", fmt.format(date));
}
...
function testDateFmtFormatRelativeWithinMinuteAfter() {
    ...
    assertEquals("在30秒", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWithinHourAfter() {
    ...
    assertEquals("在10分钟", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWithinDayAfter() {
    ...
    assertEquals("在4小时", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWithinFortnightAfter() {
    ...
    assertEquals("在4天", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWithinQuarterAfter() {
    ...
    assertEquals("在9周", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWithinTwoYearsAfter() {
    ...
    assertEquals("在16个月", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeYearsAfter() {
    ...
    assertEquals("在14年", fmt.formatRelative(reference, date));
}
