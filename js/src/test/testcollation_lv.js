...
function testJSCollatorQuatUE_lv() {
...
function testJSCollatorQuatOE_lv() {
	var col = new ilib.Collator({
		locale: "lv-LV",
		useNative: false,
		sensitivity: "quaternary"
...
function testJSCollatorQuatAE_lv() {
	var col = new ilib.Collator({
		locale: "lv-LV",
		useNative: false,
		sensitivity: "quaternary"
...
function testJSCollatorPrimaryAE_lv() {
	var col = new ilib.Collator({
		locale: "lv-LV",
		useNative: false,
		sensitivity: "primary"
...
function testJSCollatorPrimaryUE_lv() {
	var col = new ilib.Collator({
		locale: "lv-LV",
		useNative: false,
		sensitivity: "primary",
