 ...
 * range
 */
ilib.CType._inRange = function(num, rangeName, obj) {
	var range, i;
 ...
 * range
 */
ilib.CType.withinRange = function(ch, rangeName) {
	if (!rangeName) {
		return false;
	}
	var num;
 ...
 */
ilib.CType._init = function(sync, loadParams, onLoad) {
 ...
 * @param {function(*)|undefined} onLoad
 */
ilib.CType._load = function (name, sync, loadParams, onLoad) {
	if (!ilib.data[name]) {
