/*
 * tolower.js - define and load a locale-sensitive lower-case mapper
 * 
...
/**
 * @class
 * Create a new string mapper instance that maps strings to lower
 ...
 * </ul>
 * 
 * Depends directive: !depends tolower.js
 * 
 * @constructor
 * @param {Object=} options options to initialize this string mapper 
 */
ilib.ToLowerMapper = function (options) {
	var sync = true,
