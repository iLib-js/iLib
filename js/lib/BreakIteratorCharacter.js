 ...
 */
var BreakIteratorCharacter = function (string, options) {
    this.sync = true;
    this.breakNumber = 0;
    this.string = new IString(string, options);
 ...
 */
BreakIteratorCharacter.prototype.hasNext = function() {
 ...
 */
BreakIteratorCharacter.prototype.next = function() {
    var ret;
 ...
 */
BreakIteratorCharacter.prototype.first = function() {
    this.breakNumber = 0;
 ...
 * of text in the string
 */
BreakIteratorCharacter.prototype.last = function() {
 ...
 */
BreakIteratorCharacter.prototype.previous = function() {
    var ret;
...
module.exports = BreakIteratorCharacter;
