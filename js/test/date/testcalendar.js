...
module.exports.testcalendar = {
    testDefaultCalendar_GregorianCaseAll: function(test) {
        ...
        "he-IL","hi-IN","hi-SG","hr-HR","hr-ME","hu-HU","hy-AM","id-ID","ig-NG","is-IS","it-CH","it-IT","ja-JP","ka-GE","kk-Cyrl-KZ","km-KH","kn-IN",
        ...
        "pa-PK","ps-PK","pl-PL","pt-AO","pt-BR","pt-GQ","pt-CV","pt-PT","ro-RO","ru-BY","ru-GE","ru-KG","ru-KZ","ru-RU","ru-UA","si-LK",
    ...
    testDefaultCalendar_ps_AF: function(test) {
        test.expect(2);
