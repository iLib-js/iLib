...
module.exports.testdatetimeformat = {
    ...
    testDateTimeFormat_bg_BG: function(test) {
        ...
        test.equal(result1, 'H:mm:ss \'ч\'. z');
    ...
    testDateTimeFormat_mk_MK: function(test) {
        ...
        test.equal(result1, 'EEEE, d MMMM yyyy, \'во\' HH:mm');
    ...
    testDateTimeFormat_lb_LU: function(test) {
        ...
        result1 = new DateFmt({locale:"lb-LUG", type:"time", time:"ahmsz", length:"full", useNative:false, timezone:"local"}).template;
        test.equal(result1,  "HH:mm:ss z");
