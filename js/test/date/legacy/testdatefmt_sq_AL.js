...
function testDateFmtINSimpleTimeShort_sq_AL() {
    ...
    assertEquals("1:45 e pasdites", fmt.format(date));
}
...
function testDateFmtINDateTimeSimpleShort_sq_AL() {
    ...
    assertEquals("29.9.11, 1:45 e pasdites", fmt.format(date));
}
...
function testDateFmtINDateTimeSimpleMedium_sq_AL() {
    ...
    assertEquals("29 sht 2011, 1:45 e pasdites", fmt.format(date));
}
...
function testDateFmtINDateTimeSimpleLong_sq_AL() {
    ...
    assertEquals("29 shtator 2011 në 1:45 e pasdites", fmt.format(date));
}
...
function testDateFmtINFullDateComponentsWDM_sq_AL() {
    ...
    assertEquals("e enjte, 29 shtator", fmt.format(date));
}
...
function testDateFmtINFullDateComponentsWDMY_sq_AL() {
    ...
    assertEquals("e enjte, 29 shtator 2011", fmt.format(date));
}
...
function testDateFmtINShortTimeComponentsHMZ_sq_AL() {
    ...
    assertEquals("1:45:37 e pasdites CEST", fmt.format(date));
}
...
function testDateFmtINFullTimeComponentsHMS_sq_AL() {
    ...
    assertEquals("1:45:37 e pasdites", fmt.format(date));
}
...
function testDateFmtINWithTimeZoneAndNoDST_sq_AL() {
    ...
    assertEquals("1:45:37 e pasdites CET", fmt.format(date));
