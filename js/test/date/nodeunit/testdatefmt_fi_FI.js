...
module.exports.testdatefmt_fi_FI = {
    ...
    testDateFmtFormatRelativeWithinMinuteAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "30 sekuntia päästä");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinHourAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "10 minuuttia päästä");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinDayAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "4 tuntia päästä");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinFortnightAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "4 päivää päästä");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinQuarterAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "9 viikkoa päästä");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinTwoYearsAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "16 kuukautta päästä");
        test.done();
    },
    ...
    testDateFmtFormatRelativeYearsAfter_fi_FI: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "14 vuotta päästä");
        test.done();
    },
