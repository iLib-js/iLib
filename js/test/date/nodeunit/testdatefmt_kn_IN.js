...
module.exports.testdatefmt_kn_IN = {
    ...
    testDateFmtFormatRelativeWitknnMinuteAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "30 ಸೆಕೆಂಡುಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnMinuteBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "30 ಸೆಕೆಂಡುಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnHourAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "10 ನಿಮಿಷಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnHourBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "10 ನಿಮಿಷಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnDayAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "4 ಗಂಟೆಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnDayBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "4 ಗಂಟೆಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWitknnFortnightAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "4 ದಿನಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnFortnightBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "4 ದಿನಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWitknnQuarterAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "9 ವಾರಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnQuarterBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "9 ವಾರಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWitknnTwoYearsAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "16 ತಿಂಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeWitknnTwoYearsBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "14 ತಿಂಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    },
    ...
    testDateFmtFormatRelativeYearsAfter_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "14 ವರ್ಷಗಳು ದಿನಗಳಲ್ಲಿ");
        test.done();
    },
    testDateFmtFormatRelativeYearsBefore_kn_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "21 ವರ್ಷಗಳು ದಿನಗಳ ಹಿಂದೆ");
        test.done();
    }
