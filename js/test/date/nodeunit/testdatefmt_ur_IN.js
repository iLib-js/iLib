...
module.exports.testdatefmt_ur_IN = {
    ...
    testDateFmtFormatRelativeWithinMinuteAfter_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏30 سیکنڈوں میں");
        test.done();
    ...
    testDateFmtFormatRelativeWithinMinuteBefore_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏30 سیکنڈوں پہلے");
        test.done();
    },
    testDateFmtFormatRelativeWithinHourAfter_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏10 منٹوں میں");
        test.done();
    },
    testDateFmtFormatRelativeWithinHourBefore_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏10 منٹوں پہلے");
        test.done();
    },
    testDateFmtFormatRelativeWithinDayAfter_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏4 گھنٹےوں میں");
        test.done();
    },
    testDateFmtFormatRelativeWithinDayBefore_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏4 گھنٹےوں پہلے");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinQuarterAfter_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏9 ہفتےوں میں");
        test.done();
    },
    testDateFmtFormatRelativeWithinQuarterBefore_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏9 ہفتےوں پہلے");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinTwoYearsAfter_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏16 مہینےوں میں");
        test.done();
    },
    testDateFmtFormatRelativeWithinTwoYearsBefore_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏14 مہینےوں پہلے");
        test.done();
    },
    ...
    testDateFmtFormatRelativeYearsBefore_ur_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "‏21 سالوں پہلے");
        test.done();
    }
