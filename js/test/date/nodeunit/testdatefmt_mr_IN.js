...
module.exports.testdatefmt_mr_IN = {
    ...
    testDateFmtINSimpleTimeShort_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "१:४५ म.उ.");
        test.done();
    },
    ...
    testDateFmtINSimpleTimeShort_mr_IN1: function(test) {
        ...
        test.equal(fmt.format(date), "1:45 म.उ.");
        test.done();
    },
    ...
    testDateFmtINDateTimeSimpleShort_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "२९/९/११, १:४५ म.उ.");
        test.done();
    },
    ...
    testDateFmtINDateTimeSimpleMedium_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "२९ सप्टें, २०११, १:४५ म.उ.");
        test.done();
    },
    ...
    testDateFmtINDateTimeSimpleLong_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "29 सप्टेंबर, 2011 रोजी 1:45 म.उ.");
        test.done();
    },
    ...
    testDateFmtINDateTimeSimpleFull_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "२९ सप्टेंबर, २०११ रोजी १:४५ म.उ.");
        test.done();
    },
    ...
    testDateFmtINShortTimeComponentsHMZ_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "१:४५:३७ म.उ. IST");
        test.done();
    },
    ...
    testDateFmtINShortTimeComponentsHMSA_mr_IN: function(test) {
        ...
        test.equal(fmt.format(date), "१:४५:३७ म.उ.");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinHourAfter_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "10 मिनिटेांमध्ये");
        test.done();
    },
    testDateFmtFormatRelativeWithinHourBefore_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "10 मिनिटेांपूर्वी");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinQuarterAfter_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "9 आठवडेांमध्ये");
        test.done();
    },
    testDateFmtFormatRelativeWithinQuarterBefore_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "9 आठवडेांपूर्वी");
        test.done();
    },
    ...
    testDateFmtFormatRelativeWithinTwoYearsAfter_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "16 महिनेांमध्ये");
        test.done();
    },
    testDateFmtFormatRelativeWithinTwoYearsBefore_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "14 महिनेांपूर्वी");
        test.done();
    },
    ...
    testDateFmtFormatRelativeYearsAfter_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "14 वर्षेांमध्ये");
        test.done();
    },
    testDateFmtFormatRelativeYearsBefore_mr_IN: function(test) {
        ...
        test.equal(fmt.formatRelative(reference, date), "21 वर्षेांपूर्वी");
        test.done();
    }
