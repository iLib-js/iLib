...
function testDateFmtINSimpleTimeShort_gu_IN() {
    ...
    assertEquals("01:45 PM", fmt.format(date));
}
...
function testDateFmtINShortTimeComponentsHMZ_gu_IN() {
    ...
    assertEquals("01:45:37 PM IST", fmt.format(date));
}
...
function testDateFmtINShortTimeComponentsHMSA_gu_IN() {
    ...
    assertEquals("01:45:37 PM", fmt.format(date));
}
...
function testDateFmtFormatRelativeWitgunMinuteBefore_gu_IN() {
    ...
    assertEquals("30 સેકંડ પહેલાં", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWitgunHourBefore_gu_IN() {
    ...
    assertEquals("10 મિનિટ પહેલાં", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWitgunDayBefore_gu_IN() {
    ...
    assertEquals("4 કલાક પહેલાં", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWitgunQuarterBefore_gu_IN() {
    ...
    assertEquals("9 અઠવાડિયા પહેલાં", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeWitgunTwoYearsBefore_gu_IN() {
    ...
    assertEquals("14 મહિના પહેલાં", fmt.formatRelative(reference, date));
}
...
function testDateFmtFormatRelativeYearsBefore_gu_IN() {
    ...
    assertEquals("21 વર્ષ પહેલાં", fmt.formatRelative(reference, date));
}
