...
module.exports.testunitfmt = {
    ...
    testUnitFormatSpeed4: function(test) {
        ...
        var str = uf.format(m1);
        test.expect(1);
        test.equal(str, "1,000 feet per second");
        test.done();
    },
    ...
    testUnitFormatSpeed5: function(test) {
        ...
        var str = uf.format(m1);
        test.expect(1);
        test.equal(str, "1 000 milles anglais par heure");
        test.done();
    },
