...
function testDateRngFmtasINRangeinDayShort() {
    ...
    assertEquals("২০১১-১২-৩১ ১৩:৪৫ – ১৪:৩০", fmt.format(start, end));
}
function testDateRngFmtasINRangeinDayMedium() {
    ...
    assertEquals("২০১১ ডিসে ৩১ ১৩:৪৫ – ১৪:৩০", fmt.format(start, end));
}
function testDateRngFmtasINRangeinDayLong() {
    ...
    assertEquals("২০১১ ডিচেম্বৰ ৩১ ১৩:৪৫ – ১৪:৩০", fmt.format(start, end));
}
...
function testDateRngFmtasINRangeNextDayShort() {
    ...
    assertEquals("২০১১-১২-৩০ ১৩:৪৫ – ২০১১-১২-৩১ ১৪:৩০", fmt.format(start, end));
}
function testDateRngFmtasINRangeNextDayMedium() {
    ...
    assertEquals("২০১১ ডিসে ৩০ ১৩:৪৫ – ২০১১ ডিসে ৩১ ১৪:৩০", fmt.format(start, end));
}
function testDateRngFmtasINRangeNextDayLong() {
    ...
    assertEquals("২০১১ ডিচেম্বৰ ৩০ ১৩:৪৫ – ২০১১ ডিচেম্বৰ ৩১ ১৪:৩০", fmt.format(start, end));
}
