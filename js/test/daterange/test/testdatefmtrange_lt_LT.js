...
function testDateRngFmtLTRangeNextDayLong() {
    ...
    assertEquals("13:45 2011 m. gruodžio 30 – 14:30 d.–31 d.", fmt.format(start, end));
}
...
function testDateRngFmtLTRangeNextMonthLong() {
    ...
    assertEquals("2011–lapkričio–20 – gruodžio–31", fmt.format(start, end));
}
...
function testDateRngFmtLTRangeNextYearLong() {
    ...
    assertEquals("2011–lapkričio–20 – 2012–sausio–31", fmt.format(start, end));
}
...
function testDateRngFmtLTRangeMultiYearLong() {
    ...
    assertEquals("2011–lapkričio – 2014–sausio", fmt.format(start, end));
}
function testDateRngFmtLTRangeMultiYearFull() {
    ...
    assertEquals("lapkričio 2011 – sausio 2014", fmt.format(start, end));
}
