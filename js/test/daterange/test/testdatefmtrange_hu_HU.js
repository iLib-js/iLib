...
function testDateRngFmtHURangeNextDayMedium() {
    ...
    assertEquals("2011. dec. 30. 13:45 – 2011. dec. 31. 14:30", fmt.format(start, end));
}
function testDateRngFmtHURangeNextDayLong() {
    ...
    assertEquals("2011. december 30. 13:45 – 2011. december 31. 14:30", fmt.format(start, end));
}
...
function testDateRngFmtHURangeNextMonthMedium() {
    ...
    assertEquals("2011. nov. 20. – 2011. dec. 31.", fmt.format(start, end));
}
