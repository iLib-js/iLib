/*
 * testdatefmtrange_ckb_IQ.js - test the date range formatter object in
...
module.exports.testdatefmtrange_ckb_IQ = {
    ...
    testDateRngFmtKuRangeInDayShort: function(test) {
        test.expect(2);
        var fmt = new DateRngFmt({locale: "ckb-IQ", length: "short"});
        test.ok(fmt !== null);
    ...
    testDateRngFmtKuRangeInDayMedium: function(test) {
        test.expect(2);
        var fmt = new DateRngFmt({locale: "ckb-IQ", length: "medium"});
        test.ok(fmt !== null);
    ...
    testDateRngFmtKuRangeInDayLong: function(test) {
        test.expect(2);
        var fmt = new DateRngFmt({locale: "ckb-IQ", length: "long"});
        test.ok(fmt !== null);
    ...
    testDateRngFmtKuRangeInDayFull: function(test) {
        test.expect(2);
        var fmt = new DateRngFmt({locale: "ckb-IQ", length: "full"});
        test.ok(fmt !== null);
