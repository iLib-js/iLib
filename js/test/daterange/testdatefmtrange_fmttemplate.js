...
module.exports.testdaterangefmt = {
    ...
    testDateRngFmt_bg_BG: function(test) {
        ...
        test.equal(templatec01[0], '{sd} {sm} {sy} г., {st} – {ed} {em} {ey} г., {et}');
        test.equal(templatec01[1], '{sd} {sm} {sy} г., {st} – {ed} {em} {ey} г., {et}');
        test.equal(templatec01[2], '{sd}.{sm}.{sy} г., {st} – {ed}.{em}.{ey} г., {et}');
        test.equal(templatec01[3], '{sd}.{sm}.{sy} г., {st} – {ed}.{em}.{ey} г., {et}');

        test.equal(templatec02[0], '{sd} {sm} {sy} г., {st} – {ed} {em} {ey} г., {et}');
        test.equal(templatec02[1], '{sd} {sm} {sy} г., {st} – {ed} {em} {ey} г., {et}');
        test.equal(templatec02[2], '{sd}.{sm}.{sy} г., {st} – {ed}.{em}.{ey} г., {et}');
        test.equal(templatec02[3], '{sd}.{sm}.{sy} г., {st} – {ed}.{em}.{ey} г., {et}');

        test.equal(templatec03[0], '{sd} {sm} {sy} г., {st} – {ed} {em} {ey} г., {et}');
        test.equal(templatec03[1], '{sd} {sm} {sy} г., {st} – {ed} {em} {ey} г., {et}');
        ...
        test.equal(templatec30[0], '{sy} г. – {ey} г.');
        test.equal(templatec30[1], '{sy} г. – {ey} г.');
        test.equal(templatec30[2], '{sy} г. – {ey} г.');
        test.equal(templatec30[3], '{sy} г. – {ey} г.');
    ...
    testDateRngFmt_da_DK: function(test) {
        ...
        test.equal(templatec00[2], '{sd}. {sm} {sy} {st} – {et}');
        test.equal(templatec00[3], '{sd}.{sm}.{sy} {st} – {et}'); // CLDR 34 change
    ...
    testDateRngFmt_es_MX: function(test) {
        ...
        test.equal(templatec00[0], '{sd} de {sm} de {sy}, {st} – {et}');
        test.equal(templatec00[1], '{sd} de {sm} de {sy}, {st} – {et}');
        test.equal(templatec00[2], '{sd} {sm} {sy} {st} – {et}'); // CLDR 34 change
        test.equal(templatec00[3], '{sd}/{sm}/{sy} {st} – {et}');

        test.equal(templatec01[0], '{sd} de {sm} de {sy}, {st} – {ed} de {em} de {ey}, {et}');
        test.equal(templatec01[1], '{sd} de {sm} de {sy}, {st} – {ed} de {em} de {ey}, {et}');
        test.equal(templatec01[2], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}'); // CLDR 34 change
        test.equal(templatec01[3], '{sd}/{sm}/{sy} {st} – {ed}/{em}/{ey} {et}');

        test.equal(templatec02[1], '{sd} de {sm} de {sy}, {st} – {ed} de {em} de {ey}, {et}');
        test.equal(templatec02[0], '{sd} de {sm} de {sy}, {st} – {ed} de {em} de {ey}, {et}');
        test.equal(templatec02[2], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}'); // CLDR 34 change
        test.equal(templatec02[3], '{sd}/{sm}/{sy} {st} – {ed}/{em}/{ey} {et}');
    ...
    testDateRngFmt_fa_AF: function(test) {
        ...
        test.equal(templatec00[0], '‏ساعت {st} تا {et} ،{sd} {sm} {sy}');
        test.equal(templatec00[1], '‏ساعت {st} تا {et} ،{sd} {sm} {sy}');
        test.equal(templatec00[2], '‏{st} تا {et} ،{sd} {sm} {sy}');
        test.equal(templatec00[3], '‏{st} تا {et} ،{sd}‏/{sm}‏/{sy}');

        test.equal(templatec01[0], '‏ساعت {st} ،{sd} {sm} {sy} تا ساعت {et} ،{ed} {em} {ey}');
        test.equal(templatec01[1], '‏ساعت {st} ،{sd} {sm} {sy} تا ساعت {et} ،{ed} {em} {ey}');
        test.equal(templatec01[2], '‏{st} ،{sd} {sm} {sy} تا {et} ،{ed} {em} {ey}');
        test.equal(templatec01[3], '‏{st} ،{sd}‏/{sm}‏/{sy} تا {et} ،{ed}‏/{em}‏/{ey}');

        test.equal(templatec02[1], '‏ساعت {st} ،{sd} {sm} {sy} تا ساعت {et} ،{ed} {em} {ey}');
        test.equal(templatec02[0], '‏ساعت {st} ،{sd} {sm} {sy} تا ساعت {et} ،{ed} {em} {ey}');
        test.equal(templatec02[2], '‏{st} ،{sd} {sm} {sy} تا {et} ،{ed} {em} {ey}');
        test.equal(templatec02[3], '‏{st} ،{sd}‏/{sm}‏/{sy} تا {et} ،{ed}‏/{em}‏/{ey}');

        test.equal(templatec03[0], '‏ساعت {st} ،{sd} {sm} {sy} تا ساعت {et} ،{ed} {em} {ey}');
        test.equal(templatec03[1], '‏ساعت {st} ،{sd} {sm} {sy} تا ساعت {et} ،{ed} {em} {ey}');
        test.equal(templatec03[2], '‏{st} ،{sd} {sm} {sy} تا {et} ،{ed} {em} {ey}');
        test.equal(templatec03[3], '‏{st} ،{sd}‏/{sm}‏/{sy} تا {et} ،{ed}‏/{em}‏/{ey}');

        test.equal(templatec10[0], '‏{sd} تا {ed} {em} {ey}');
        test.equal(templatec10[1], '‏{sd} تا {ed} {em} {ey}');
        test.equal(templatec10[2], '‏{sd} تا {ed} {em} {ey}');
        test.equal(templatec10[3], '‏{sd} تا {ed}‏/{sm}‏/{sy}');

        test.equal(templatec11[0], '‏{sd} {sm} {sy} تا {ed} {em}');
        test.equal(templatec11[1], '‏{sd} {sm} تا {ed} {em} {ey}');
        test.equal(templatec11[2], '‏{sd} {sm} تا {ed} {em} {ey}');
        test.equal(templatec11[3], '‏{sd}‏/{sm}‏/{sy} تا {ed}‏/{em}‏/{ey}' );

        test.equal(templatec12[0], '‏{sd} {sm} {sy} تا {ed} {em} {ey}');
        test.equal(templatec12[1], '‏{sd} {sm} {sy} تا {ed} {em} {ey}');
        test.equal(templatec12[2], '‏{sd} {sm} {sy} تا {ed} {em} {ey}');
        test.equal(templatec12[3], '‏{sd}‏/{sm}‏/{sy} تا {ed}‏/{em}‏/{ey}');

        test.equal(templatec20[0], '‏{sm} {sy} تا {em} {ey}');
        test.equal(templatec20[1], '‏{sm} {sy} تا {em} {ey}');
        test.equal(templatec20[2], '‏{sm} {sy} تا {em} {ey}');
        test.equal(templatec20[3], '‏{sm}‏/{sy} تا {em}‏/{ey}');

        test.equal(templatec30[0], '‏{sy} تا {ey}');
        test.equal(templatec30[1], '‏{sy} تا {ey}');
        test.equal(templatec30[2], '‏{sy} تا {ey}');
        test.equal(templatec30[3], '‏{sy} تا {ey}');
    ...
    testDateRngFmt_he_IL: function(test) {
        ...
        test.equal(templatec00[0], '‏{sd} ב{sm} {sy} בשעה {et} – {st}');
        test.equal(templatec00[1], '‏{sd} ב{sm} {sy} בשעה {et} – {st}');
        test.equal(templatec00[2], '‏{sd} ב{sm} {sy} ,{et} – {st}');
        test.equal(templatec00[3], '{sd}.{sm}.{sy} ,{et} – {st}');

        test.equal(templatec01[0], '‏{ed} ב{em} {ey} בשעה {et} – ‏{sd} ב{sm} {sy} בשעה {st}');
        test.equal(templatec01[1], '‏{ed} ב{em} {ey} בשעה {et} – ‏{sd} ב{sm} {sy} בשעה {st}');
        test.equal(templatec01[2], '‏{ed} ב{em} {ey} ,{et} – ‏{sd} ב{sm} {sy} ,{st}');
        test.equal(templatec01[3], '{ed}.{em}.{ey} ,{et} – {sd}.{sm}.{sy} ,{st}');

        test.equal(templatec02[0], '‏{ed} ב{em} {ey} בשעה {et} – ‏{sd} ב{sm} {sy} בשעה {st}');
        test.equal(templatec02[1], '‏{ed} ב{em} {ey} בשעה {et} – ‏{sd} ב{sm} {sy} בשעה {st}');
        test.equal(templatec02[2], '‏{ed} ב{em} {ey} ,{et} – ‏{sd} ב{sm} {sy} ,{st}');
        test.equal(templatec02[3], '{ed}.{em}.{ey} ,{et} – {sd}.{sm}.{sy} ,{st}');

        test.equal(templatec03[0], '‏{ed} ב{em} {ey} בשעה {et} – ‏{sd} ב{sm} {sy} בשעה {st}');
        test.equal(templatec03[1], '‏{ed} ב{em} {ey} בשעה {et} – ‏{sd} ב{sm} {sy} בשעה {st}');
        test.equal(templatec03[2], '‏{ed} ב{em} {ey} ,{et} – ‏{sd} ב{sm} {sy} ,{st}');
        test.equal(templatec03[3], '{ed}.{em}.{ey} ,{et} – {sd}.{sm}.{sy} ,{st}');

        test.equal(templatec10[0], '‏{ed} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec10[1], '‏{ed} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec10[2], '‏{ed} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec10[3], '{ed} – {sd}.{sm}.{sy}');

        test.equal(templatec11[0], '‏{ed} ב{em} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec11[1], '‏{ed} ב{em} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec11[2], '‏{ed} ב{em} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec11[3], '{ed}.{em} – {sd}.{sm}.{sy}');

        test.equal(templatec12[0], '‏{ed} ב{em} {ey} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec12[1], '‏{ed} ב{em} {ey} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec12[2], '‏{ed} ב{em} {ey} – ‏{sd} ב{sm} {sy}');
        test.equal(templatec12[3], '{ed}.{em}.{ey} – {sd}.{sm}.{sy}');

        test.equal(templatec20[0], '‏{em} {ey} – {sm} {sy}');
        test.equal(templatec20[1], '‏{em} {ey} – {sm} {sy}');
        test.equal(templatec20[2], '‏{em} {ey} – {sm} {sy}');
        test.equal(templatec20[3], '{em}.{ey} – {sm}.{sy}');

        test.equal(templatec30[0], '‏{ey} – {sy}');
        test.equal(templatec30[1], '‏{ey} – {sy}');
        test.equal(templatec30[2], '‏{ey} – {sy}');
        test.equal(templatec30[3], '‏{ey} – {sy}');
    ...
    testDateRngFmt_hi_IN: function(test) {
        ...
        test.equal(templatec01[0], '{sd} {sm} {sy} को {st} – {ed} {em} {ey} को {et}');
        test.equal(templatec01[1], '{sd} {sm} {sy} को {st} – {ed} {em} {ey} को {et}');
        test.equal(templatec01[2], '{sd} {sm} {sy}, {st} – {ed} {em} {ey}, {et}');
        test.equal(templatec01[3], '{sd}/{sm}/{sy}, {st} – {ed}/{em}/{ey}, {et}');

        test.equal(templatec02[1], '{sd} {sm} {sy} को {st} – {ed} {em} {ey} को {et}');
        test.equal(templatec02[0], '{sd} {sm} {sy} को {st} – {ed} {em} {ey} को {et}');
        test.equal(templatec02[2], '{sd} {sm} {sy}, {st} – {ed} {em} {ey}, {et}');
        test.equal(templatec02[3], '{sd}/{sm}/{sy}, {st} – {ed}/{em}/{ey}, {et}');

        test.equal(templatec03[0], '{sd} {sm} {sy} को {st} – {ed} {em} {ey} को {et}');
        test.equal(templatec03[1], '{sd} {sm} {sy} को {st} – {ed} {em} {ey} को {et}');
        test.equal(templatec03[2], '{sd} {sm} {sy}, {st} – {ed} {em} {ey}, {et}');
        test.equal(templatec03[3], '{sd}/{sm}/{sy}, {st} – {ed}/{em}/{ey}, {et}');
    ...
    testDateRngFmt_ko_KR: function(test) {
        ...
        test.equal(templatec00[1], '{sy}년 {sm}월 {sd}일 {st} – {et}');
        test.equal(templatec00[2], '{sy}. {sm}. {sd}. {st} – {et}');
        test.equal(templatec00[3], '{sy}. {sm}. {sd}. {st} – {et}');

        test.equal(templatec01[0], '{sy}년 {sm}월 {sd}일 {st} – {ey}년 {em}월 {ed}일 {et}');
        test.equal(templatec01[1], '{sy}년 {sm}월 {sd}일 {st} – {ey}년 {em}월 {ed}일 {et}');
        test.equal(templatec01[2], '{sy}. {sm}. {sd}. {st} – {ey}. {em}. {ed}. {et}');
        test.equal(templatec01[3], '{sy}. {sm}. {sd}. {st} – {ey}. {em}. {ed}. {et}');

        test.equal(templatec02[1], '{sy}년 {sm}월 {sd}일 {st} – {ey}년 {em}월 {ed}일 {et}');
        test.equal(templatec02[0], '{sy}년 {sm}월 {sd}일 {st} – {ey}년 {em}월 {ed}일 {et}');
        test.equal(templatec02[2], '{sy}. {sm}. {sd}. {st} – {ey}. {em}. {ed}. {et}');
        test.equal(templatec02[3], '{sy}. {sm}. {sd}. {st} – {ey}. {em}. {ed}. {et}');

        test.equal(templatec03[0], '{sy}년 {sm}월 {sd}일 {st} – {ey}년 {em}월 {ed}일 {et}');
        test.equal(templatec03[1], '{sy}년 {sm}월 {sd}일 {st} – {ey}년 {em}월 {ed}일 {et}');
        test.equal(templatec03[2], '{sy}. {sm}. {sd}. {st} – {ey}. {em}. {ed}. {et}');
        test.equal(templatec03[3], '{sy}. {sm}. {sd}. {st} – {ey}. {em}. {ed}. {et}');

        test.equal(templatec10[0], '{sy}년 {sm}월 {sd}일 – {ed}일');
        test.equal(templatec10[1], '{sy}년 {sm}월 {sd}일 – {ed}일');
        test.equal(templatec10[2], '{sy}. {sm}. {sd}. – {ed}');
        test.equal(templatec10[3], '{sy}. {sm}. {sd}. – {ed}');

        test.equal(templatec11[0], '{sy}년 {sm}월 {sd}일 – {em}월 {ed}일');
        test.equal(templatec11[1], '{sy}년 {sm}월 {sd}일 – {em}월 {ed}일');
        test.equal(templatec11[2], '{sy}. {sm}. {sd}. – {ey}. {em}. {ed}.');
        test.equal(templatec11[3], '{sy}. {sm}. {sd}. – {ey}. {em}. {ed}.');

        test.equal(templatec12[0], '{sy}년 {sm}월 {sd}일 – {ey}년 {em}월 {ed}일');
        test.equal(templatec12[1], '{sy}년 {sm}월 {sd}일 – {ey}년 {em}월 {ed}일');
        test.equal(templatec12[2], '{sy}. {sm}. {sd}. – {ey}. {em}. {ed}.');
        test.equal(templatec12[3], '{sy}. {sm}. {sd}. – {ey}. {em}. {ed}.');
    ...
    testDateRngFmt_ku_IQ: function(test) {
        ...
        test.equal(templatec10[1], '‏{sd}ی – {ed}ی {em}ی {ey}');
        test.equal(templatec10[2], '‏{sy} {sm} {sd} – {ed}');
        test.equal(templatec10[3], '‏{sy}-{sm}-{sd} – {ed}');

        test.equal(templatec11[0], '‏{sy} {sm} {sd} – {em} {ed}');
        test.equal(templatec11[1], '‏{sd}ی {sm}ی – {em}ی {ed}ی {ey}');
        test.equal(templatec11[2], '‏{sy} {sm} {sd} – {ey} {em} {ed}');
        test.equal(templatec11[3], '‏{sy}-{sm}-{sd} – {ey}-{em}-{ed}}');
    ...
    testDateRngFmt_vi_VN: function(test) {
        ...
        test.equal(templatec00[1], '{st} – {et} {sd} {sm}, {sy}');
        test.equal(templatec00[2], '{st} – {et}, {sd} {sm}, {sy}');
        test.equal(templatec00[3], '{st} – {et}, {sd}/{sm}/{sy}');

        test.equal(templatec01[0], '{st} {sd} {sm}, {sy} – {et} {ed} {em}, {ey}');
        test.equal(templatec01[1], '{st} {sd} {sm}, {sy} – {et} {ed} {em}, {ey}');
        test.equal(templatec01[2], '{st}, {sd} {sm}, {sy} – {et}, {ed} {em}, {ey}');
        test.equal(templatec01[3], '{st}, {sd}/{sm}/{sy} – {et}, {ed}/{em}/{ey}');

        test.equal(templatec02[1], '{st} {sd} {sm}, {sy} – {et} {ed} {em}, {ey}');
        test.equal(templatec02[0], '{st} {sd} {sm}, {sy} – {et} {ed} {em}, {ey}');
        test.equal(templatec02[2], '{st}, {sd} {sm}, {sy} – {et}, {ed} {em}, {ey}');
        test.equal(templatec02[3], '{st}, {sd}/{sm}/{sy} – {et}, {ed}/{em}/{ey}');

        test.equal(templatec03[0], '{st} {sd} {sm}, {sy} – {et} {ed} {em}, {ey}');
        test.equal(templatec03[1], '{st} {sd} {sm}, {sy} – {et} {ed} {em}, {ey}');
    ...
    testDateRngFmt_mn_MN: function(test) {
        ...
        test.equal(templatec20[0], '{sy}.{sm} – {ey}.{em}');
        test.equal(templatec20[1], '{sy}.{sm} – {ey}.{em}');
        test.equal(templatec20[2], '{sy} оны {sm}ын – {ey} оны {em}ын');
        test.equal(templatec20[3], '{sy}.{sm} – {ey}.{em}');
    ...
    testDateRngFmt_am_ET: function(test) {
        ...
        test.equal(templatec00[0], '{sm} {sd} ቀን {sy} ዓ.ም {st} – {et}');
        test.equal(templatec00[1], '{sd} {sm} {sy} {st} – {et}');
        test.equal(templatec00[2], '{sd} {sm} {sy} {st} – {et}');
        test.equal(templatec00[3], '{sd}/{sm}/{sy} {st} – {et}');

        test.equal(templatec01[0], '{sm} {sd} ቀን {sy} {st} – {em} {ed} ቀን {sy} ዓ.ም {et}');
        test.equal(templatec01[1], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}');
        test.equal(templatec01[2], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}');
        test.equal(templatec01[3], '{sd}/{sm}/{sy} {st} – {ed}/{em}/{ey} {et}');

        test.equal(templatec02[0], '{sm} {sd} ቀን {sy} {st} – {em} {ed} ቀን {sy} ዓ.ም {et}');
        test.equal(templatec02[1], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}');
        test.equal(templatec02[2], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}');
        test.equal(templatec02[3], '{sd}/{sm}/{sy} {st} – {ed}/{em}/{ey} {et}');

        test.equal(templatec03[0], '{sm} {sd} ቀን {sy} {st} – {em} {ed} ቀን {sy} ዓ.ም {et}');
        test.equal(templatec03[1], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}');
        test.equal(templatec03[2], '{sd} {sm} {sy} {st} – {ed} {em} {ey} {et}');
        test.equal(templatec03[3], '{sd}/{sm}/{sy} {st} – {ed}/{em}/{ey} {et}');

        test.equal(templatec10[0], '{sm} {sd} – {ed} ቀን {sy} ዓ.ም');
        test.equal(templatec10[1], '{sd} – {ed} {em} {ey}');
        test.equal(templatec10[2], '{sd} – {ed} {em} {ey}');
        test.equal(templatec10[3], '{sd} – {ed}/{em}/{ey}');

        test.equal(templatec11[0], '{sm} {sd} – {em} {ed} ቀን {sy} ዓ.ም');
        test.equal(templatec11[1], '{sd} {sm} – {ed} {em} {ey}');
        test.equal(templatec11[2], '{sd} {sm} – {ed} {em} {ey}');
        test.equal(templatec11[3], '{sd}/{sm} – {ed}/{em}/{ey}');

        test.equal(templatec12[0], '{sm} {sd} ቀን {sy}  ዓ.ም – {em} {ed} ቀን {ey} ዓ.ም');
        test.equal(templatec12[1], '{sd} {sm} {sy} – {ed} {em} {ey}');
        test.equal(templatec12[2], '{sd} {sm} {sy} – {ed} {em} {ey}');
        test.equal(templatec12[3], '{sd}/{sm}/{sy} – {ed}/{em}/{ey}');

        test.equal(templatec20[0], '{sm} ቀን {sy} ዓ.ም  – {em} ቀን {ey} ዓ.ም');
        test.equal(templatec20[1], '{sm} {sy} – {em} {ey}');
        test.equal(templatec20[2], '{sm} {sy} – {em} {ey}');
        test.equal(templatec20[3], '{sm}/{sy} – {em}/{ey}');
