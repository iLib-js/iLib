...
function testParseAddressTWTWAsianNormal() {
	var parsedAddress = new ilib.Address("台灣高雄市苓雅區802四維三路6號18樓A", {locale: 'zh-Hant-TW'});
...
function testParseAddressTWTWAsianNoZip() {
	var parsedAddress = new ilib.Address("台灣台灣省台北市南港區經貿二路66號10樓", {locale: 'zh-Hant-TW'});
...
function testParseAddressTWTWAsianWithRegion() {
	var parsedAddress = new ilib.Address("台灣台灣省台高雄市苓雅區802四維三路6號18樓A", {locale: 'zh-Hant-TW'});
