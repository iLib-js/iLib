...
module.exports.testcm_KR = {
    setUp: function(callback) {
        ilib.clearCache();
        callback();
    },

    testCharmapKRTestAliases: function(test) {
    ...
    testCharmapKRMapToUnicode: function(test) {
        for (var charset in testDataKR) {
            ...
            for (var element in data) {
                ...
                test.equal(element, cm.mapToUnicode(data[element]), "testing " + charset + " element " + element + "\n");
            }
        }
        test.done();
    },
