...
module.exports.testdatetimeformat = {
    ...
    testDateTimeFormat_bs_Latn_BA: function(test) {
        ...
        test.equal(value[0], "EEEE, dd. MMMM yyyy. 'u' HH:mm");
    ...
    testDateTimeFormat_fa_AF: function(test) {
        ...
        test.equal(value[0], 'ساعت ‏H:mm، ‏EEEE، d MMMM yyyy');
        test.equal(value[3], '‏H:mm،‏ ‏E، d‏/M‏/yyyy');
    ...
    testDateTimeFormat_zh_Hant_HK: function(test) {
        ...
        test.equal(value[1], "yyyy年M月d日EEE");
        test.equal(value[2], "yyyy年M月d日EE");
        test.equal(value[3], "yyyy年M月d日E");  //// LG specific overriding ////
        ...
        test.equal(value[0], "yyyy年M月d日EEEE ah:mm");
        test.equal(value[3], "yyyy年M月d日E ah:mm");
    ...
    testDateTimeFormat_zh_Hant_TW: function(test) {
        ...
        test.equal(value[0], "yyyy年M月d日 EEEE H:mm"); ///// LG speicic overriding. 24 hours ///
    ...
    testDateTimeFormat_am_ET: function(test) {
        ...
        test.equal(value[0], "EEEE፣ MMMM d ቀን yyyy ዓ.ም");
        test.equal(value[1], "EEE፣ d MMMM yyyy");
        test.equal(value[2], "EE፣ d MMM yyyy");
        test.equal(value[3], "E፣ dd/MM/yyyy");
        ...
        test.equal(value[0], "EEEE፣ MMMM d ቀን yyyy ዓ.ም a h:mm");
        test.equal(value[3], "E፣ dd/MM/yyyy a h:mm");
    ...
    testDateTimeFormat_ha_Latn_NG: function(test) {
        ...
        test.equal(value[0], "EEEE, d MMMM, yyyy h:mm a"); //// LG speicic override : 12 hours 
        test.equal(value[3], "E, d/M/yy h:mm a"); //// LG speicic override : 12 hours 
