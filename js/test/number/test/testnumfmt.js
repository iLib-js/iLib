...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_ta_IN() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "ta-IN",
    currency: "INR"
...
function testNumFmtPercentageFormatNegative_ta_IN() {
    var fmt = new NumFmt({
    locale: "ta-IN",
    useNative: true,
        type: "percentage"
...
function testNumFmtPercentageNativeFormatNegative_ta_IN() {
    var fmt = new NumFmt({
    locale: "ta-IN",
        type: "percentage"
    });
...
function testNumFmtPercentageFormatNegative_or_IN() {
    var fmt = new NumFmt({
    locale: "or-IN",
    useNative: true,
        type: "percentage"
...
function testNumFmtPercentageNativeFormatNegative_or_IN() {
    var fmt = new NumFmt({
    locale: "or-IN",
        type: "percentage"
    });
...
function testNumFmtPercentageFormatNegative_ml_IN() {
    var fmt = new NumFmt({
    locale: "ml-IN",
    useNative: true,
        type: "percentage"
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_te_IN() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "te-IN",
    currency: "INR"
...
function testNumFmtPercentageFormatNegative_te_IN() {
    var fmt = new NumFmt({
    locale: "te-IN",
    useNative: true,
        type: "percentage"
...
function testNumFmtPercentageNativeFormatNegative_te_IN() {
    var fmt = new NumFmt({
    locale: "te-IN",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_pa_IN() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "pa-IN",
    currency: "INR"
...
function testNumFmt_ur_IN() {
    ...
    assertEquals("‎-‎۱,۲۳۴,۵۶۸.۷۸", fmt.format(-1234568.78));
}
...
function testNumFmtCurrencyFormatNativeCurrencyForLocale_ur_IN1() {
    ...
    assertEquals("₹ ۱۰۰,۱۱۰.۵۷", fmt.format(100110.57));
}
...
function testNumFmtPercentageNativeFormatNegative_ur_IN() {
    var fmt = new NumFmt({
    locale: "ur-IN",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_zh_Hans_CN() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "zh-Hans-CN",
        currency: "CNY"
...
function testNumFmtPercentageFormatNegativeRegular_zh_Hans_CN() {
    var fmt = new NumFmt({
    locale: "zh-Hans-CN",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_sv_SE() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "sv-SE",
    currency: "SEK"
...
function testNumFmtPercentageFormatNegative_sv_SE() {
    var fmt = new NumFmt({
    locale: "sv-SE",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_fi_FI() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "fi-FI",
        currency: "EUR"
...
function testNumFmtPercentageFormatNegative_fi_FI() {
    var fmt = new NumFmt({
        locale: "fi-FI",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_ro_RO() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "ro-RO",
    currency: "RON"
...
function testNumFmtPercentageFormatNegative_ro_RO() {
    var fmt = new NumFmt({
    locale: "ro-RO",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectCurrencyForLocale_ar_SA() {
    ...
    assertEquals("١٠٠٬١١٠٫٥٧ ر.س", fmt.format(100110.57));
}
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_ar_SA() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "ar-SA",
    currency: "SAR"
...
function testNumFmtPercentageFormatNegative_ar_SA() {
    var fmt = new NumFmt({
        locale: "ar-SA",
        type: "percentage"
    });
...
function testNumFmtPercentageFormatNegative_bs_Latn_BA() {
    var fmt = new NumFmt({
    locale: "bs-Latn-BA",
        type: "percentage"
    });
...
function testNumFmtPercentageFormatNegative_de_DE() {
    var fmt = new NumFmt({
    locale: "de-DE",
        type: "percentage"
    });
...
function testNumFmtPercentageFormatNegative_et_EE() {
    var fmt = new NumFmt({
    locale: "et-EE",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectCurrencyForLocale_fa_IR() {
    ...
    assertEquals("۱۰۰٬۱۱۱ ؜﷼", fmt.format(100110.57));
}
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_fa_IR() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "fa-IR",
        currency: "IRR"
...
function testNumFmtPercentageFormatNegative_fa_IR() {
    var fmt = new NumFmt({
    locale: "fa-IR",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_lt_LT() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "lt-LT",
        currency: "EUR"
...
function testNumFmtPercentageFormatNegative_lt_LT() {
    var fmt = new NumFmt({
    locale: "lt-LT",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectCurrencyForLocale_mk_MK() {
    ...
    assertEquals("100.110,57 ден", fmt.format(100110.57));
}
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_nb_NO() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "nb-NO",
    currency: "NOK"
...
function testNumFmtPercentageFormatNegative_nb_NO() {
    var fmt = new NumFmt({
    locale: "nb-NO",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectNegativeCurrencyForLocale_ru_RU() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "ru-RU",
    currency: "RUB"
...
function testNumFmtPercentageFormatNegative_ru_RU() {
    var fmt = new NumFmt({
    locale: "ru-RU",
        type: "percentage"
    });
...
function testNumFmtCurrencyFormatCorrectCurrencyForLocale_si_LK() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "si-LK",
        currency: "LKR",
...
function testNumFmtPercentageFormatRegular_si_LK() {
    var fmt = new NumFmt({
    locale: "si-LK",
        type: "percentage"
    });
...
function testNumFmtNegativeCurrencyFormatForLocale_si_LK() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "si-LK",
        currency: "LKR"
...
function testNumFmtCurrencyFormatCorrectCurrencyForLocale_sw_KE() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "sw-Latn-KE",
        currency: "KES",
...
function testNumFmtPercentageFormatRegular_sw_KE() {
    var fmt = new NumFmt({
    locale: "sw-Latn-KE",
        type: "percentage"
    });
...
function testNumFmtNegativeCurrencyFormatForLocale_sw_KE() {
    var fmt = new NumFmt({
        type: "currency",
        locale: "sw-Latn-KE",
        currency: "KES"
